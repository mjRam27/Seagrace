...
export const team: Member[] = [
  ...
  { name: 'Srajanya', role: 'Associate Software Developer', bio: 'Product engineering with an eye for interface detail and clean UX.', photo: '/images/team/Srajanya.png' },
  { name: 'Kamal', role: 'Associate Software Developer', bio: 'Builds and tests product features with care for reliability and user experience.', photo: '/images/team/kamal.jpeg' },
  // { name: 'Amrutha', role: 'Junior Software Developer', bio: 'Builds dependable features end to end - and grows fast doing it.' },
  { name: 'Vishal', role: 'Senior Consultant', bio: 'Advises on technical direction and keeps the bar high across every build.' },
];
